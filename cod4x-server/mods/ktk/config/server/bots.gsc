init()
{
	...
	setDvar("scr_ktk_bots_amount", "10");				//Amount of bots to play with - they use a serverslot!
	setDvar("scr_ktk_bots_guardlimit", "10");			//Limit of bot guards - when this amount is reached bots assassins will not become guards when the king kills them
	setDvar("scr_ktk_bots_skillAssAssins", "0.6");		//0-1 -> 0 = they don't attack; default = 0.4
	setDvar("scr_ktk_bots_skillGuards", "0.6");			//0-1 -> 0 = they don't attack; default = 0.4
	setDvar("scr_ktk_bots_skillKing", "0.6");			//0-1 -> 0 = he doesn't attack; default = 0.4
