...
heli_think( owner, startnode, heli_team, requiredDeathCount )
{
	...
	heliFlytime = maps\mp\gametypes\_manned_helicopter::CalculateHelicopterFlytime(startnode);
	chopper.owner thread maps\mp\gametypes\_huds::HardpointLiveTimeHud("helicopter_mp", heliFlytime, chopper);
...
heli_leave()
{
	...
	leavenode = maps\mp\gametypes\_manned_helicopter::GetClosestLeaveNode(self.origin);
