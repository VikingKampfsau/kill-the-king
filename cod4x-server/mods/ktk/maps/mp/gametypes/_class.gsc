...
init()
{
	...
	level.weapons["frag"] = level.ktkWeapon["throwingKnife"];
	level.weapons["smoke"] = level.ktkWeapon["poisongas"];
	level.weapons["flash"] = "flash_grenade_mp";
	level.weapons["concussion"] = level.ktkWeapon["syrette"];
	level.weapons["c4"] = level.ktkWeapon["crossbowExp"];
