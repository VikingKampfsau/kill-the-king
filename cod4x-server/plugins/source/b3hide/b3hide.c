...
cvar_t *cvar_b3Prefix2;
cvar_t *cvar_b3Hide2;
cvar_t *cvar_b3HideLvl2;
...
PCL void OnMessageSent(char *message, int slot, qboolean *show, int mode) {
    ...
    Plugin_Cvar_GetString(cvar_b3Prefix2, tmp, sizeof(tmp));
    char b3prefix2 = tmp[0];
    int b3hidelvl2 = Plugin_Cvar_GetInteger(cvar_b3HideLvl2);
    qboolean b3hide2 = Plugin_Cvar_GetBoolean(cvar_b3Hide2);
    ...
    if(b3hide2 == qtrue && message[offset] == b3prefix2 && clients[slot].level >= b3hidelvl2) {
            *show = qfalse;
            //Plugin_ChatPrintf(slot, "* %s", message);
    }
}
...
PCL int OnInit() {
    ...
    cvar_b3Prefix = Plugin_Cvar_RegisterString("b3Prefix", "@", 0, "Prefix for loud B3 commands (usually !) to hide");
    cvar_b3Hide = Plugin_Cvar_RegisterBool("b3Hide", qtrue, 0, "Hide loud B3 commands (1 = On, 0 = Off)");
    cvar_b3HideLvl = Plugin_Cvar_RegisterInt("b3HideLvl", 20, 0, 100, 0, "Hides loud B3 commands if client's level >= b3HideLvl (default: 20)");

    cvar_b3Prefix2 = Plugin_Cvar_RegisterString("b3Prefix2", "!", 0, "Prefix for B3 commands (usually !) to hide");
    cvar_b3Hide2 = Plugin_Cvar_RegisterBool("b3Hide2", qtrue, 0, "Hide B3 commands (1 = On, 0 = Off)");
    cvar_b3HideLvl2 = Plugin_Cvar_RegisterInt("b3HideLvl2", 20, 0, 100, 0, "Hides B3 commands if client's level >= b3HideLvl2 (default: 20)");
