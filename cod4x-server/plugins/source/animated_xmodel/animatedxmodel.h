//definitions
#define INDEX_SEARCH_START 32
#define INDEX_SEARCH_END 256
...
extern void G_SetModel(gentity_t *ent, char *modelName);

extern void XanimCloneAnimtree(int from, int to);
